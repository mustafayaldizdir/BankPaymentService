...
{
    public class LydiansElektronikParaBankService : PaymentProvider
    {
        public LydiansElektronikParaBankService(IPaymentService paymentService) : base(paymentService) { }
