...
{
    public class TtOdemeVeElektronikParaBankService : PaymentProvider
    {
        public TtOdemeVeElektronikParaBankService(IPaymentService paymentService) : base(paymentService) { }
