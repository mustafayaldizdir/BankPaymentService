...
{
    public class IyziOdemeVeElektronikParaBankService : PaymentProvider
    {
        public IyziOdemeVeElektronikParaBankService(IPaymentService paymentService) : base(paymentService) { }
