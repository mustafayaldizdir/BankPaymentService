...
{
    public class PostaVeTelgrafTeskilatiBankService : PaymentProvider
    {
        public PostaVeTelgrafTeskilatiBankService(IPaymentService paymentService) : base(paymentService) { }
